...
import { Recipe } from 'src/app/public/models/recipe';
import {MatTableDataSource} from "@angular/material/table";
import {HttpDataService} from "src/app/public/services/fastfood.service";
...
export class  FastfoodtableComponent {
  ...
  getAllMovies() {
    this.httpDataService.getList().subscribe((response: any) => {
      this.dataSource.data = response.recipes;
